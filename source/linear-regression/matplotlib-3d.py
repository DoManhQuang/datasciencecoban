...
if __name__ == '__main__':
    ...
    display_chart_linear(muc_nuoc_ox, dong_xa_oy, lin_model.coef_.T, oxy_array)

    print('Solution found by sk-learn: ', lin_model.coef_)
    print('Solution found by team', liner_vector.T)
